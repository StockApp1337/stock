        ...
        for(var i = 1; i <= pdf.numPages; i++){
          pdf.getPage(i).then(function(page){
            ...
            page.getTextContent().then(function(text){
              ...
              if(cleanedArray[q].str == "Purchase Name" || cleanedArray[q].str == "Unit" || cleanedArray[q].str == "Theoretical" || cleanedArray[q].str == "Close Qty" || cleanedArray[q].str == "Closing Quantity" || cleanedArray[q].str == "TOTAL" || cleanedArray[q].str == "11 Bottled Cider" || cleanedArray[q].str == "12 Bottled Lager" || cleanedArray[q].str == "12A NA Bottled Lager" || cleanedArray[q].str == "13 Bottled Spirit" || cleanedArray[q].str == "14 Shots" || cleanedArray[q].str == "15 Fortified" || cleanedArray[q].str == "17 Spirits" || cleanedArray[q].str == "17A NA Spirits" || cleanedArray[q].str == "19 Cocktail Glasses" || cleanedArray[q].str == "24 Wines" || cleanedArray[q].str == "25 Sparkling" || cleanedArray[q].str == "26 Mins - Energy" || cleanedArray[q].str == "27 Mins - Mixers" || cleanedArray[q].str == "28 Mins - Packaged" || cleanedArray[q].str == "29 Mins - Non Pack" || cleanedArray[q].str == "33 Bar Garnish" || cleanedArray[q].str == "Dry Recipe Line") {
                continue;
